...
def parse_args():
    ...
    parser.add_argument("--yolo_cfg", type=str, default="YOLOv3/cfg/yolo-drone.cfg")
    parser.add_argument("--yolo_weights", type=str, default="YOLOv3/yolo-drone.weights")
    parser.add_argument("--yolo_names", type=str, default="YOLOv3/cfg/drone.names")
